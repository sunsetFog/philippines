    ...
    <table cellspacing="0" cellpadding="0" border="0" class="el-table__body" style="width: 100%;">
      <tbody>
        ...
        <tr class="el-table__row">
            ...
            <td rowspan="1" colspan="1">
              <div class="cell">
                ...
                <el-input style="width:40%" v-else  v-model="form.exit_balance"></el-input>
                <span>元  一局结束后少于此余额即退出牌桌</span>
              </div>
            </td>
        </tr>
            ...
            <td rowspan="1" colspan="1">
              <div class="cell">
               ...
               <span v-if="spanshow">{{form.bet_interval_down}}</span>
                ...
                <span>最高</span><span v-if="spanshow">{{form.bet_interval_up}}</span><el-input style="width:30%" v-else   v-model="form.bet_interval_up"></el-input><span>秒</span>
              </div>
            </td>
        </tr>
        <tr class="el-table__row">
       ...
       <tr class="el-table__row">
            ...
            <td rowspan="1" colspan="1" style="width:18%;">
              <div class="cell">
                <span>筹码使用权重   确认投注后按照权重随机的筹码，正整数填写</span><br/>
