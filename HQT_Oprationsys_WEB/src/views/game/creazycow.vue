          ...
          <div class="query">
            ...
            width='200'
              ...
              <template slot-scope="scope">
                ...
                <el-button @click="addtzx(scope.row)" type="text" size="small" class="" v-if='gamertpsetgetrtpsetinfo'>RTP管理</el-button>
    ...
    <table cellspacing="0" cellpadding="0" border="0" class="el-table__body" style="width: 100%;">
      ...
      <el-dialog :title='title'  :visible.sync="dialogFormVisible" :before-close="reset1">
        ...
        <el-form-item label="桌子名称：" :label-width="formLabelWidth" prop='table'>
          <el-input v-model="form1.table" clearable style="width:80%"></el-input>
          <!-- <span>{{multiple}}</span> -->
        </el-form-item>
        <el-form-item label="投注倒计时长" :label-width="formLabelWidth" prop='number'>
...
function getRate (that) {
    request({
      ...
      for(let i=0;i<res.data.length;i++){
        if(res.data[i].id==901&&res.data[i].type==0){
