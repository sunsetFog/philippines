        ...
        <el-form :inline="true" label-width="160px">
          ...
          <el-col :span="8">
            <el-form-item label="火车头位置编号">
               <el-select v-model="formInline.item" clearable>
                <el-option
...
<!-- :summary-method="getsummary" -->
    ...
    <el-table-column
      label="连续图案数量">
      <template slot-scope="scope">
        <el-select v-model="scope.row.item" clearable v-if="editshow">
                <el-option
                  v-for="item in list"
                  :key="item.id"
                  :label="item.name"
    ...
    <el-table-column
      label="火车头位置编号">
      <template slot-scope="scope">
      <el-select v-model="scope.row.pos" clearable v-if="editshow">
                <el-option
                  v-for="item in headlist"
                  :key="item.id"
                  :label="item.name"
    ...
    <el-table-column
      label="开火车概率">
      <template slot-scope="scope">
        <el-input v-model="scope.row.pr" type='number' v-if="editshow"></el-input>
    ...
    <el-table-column
      label="操作">
      <template slot-scope="scope">
        <el-button type="text" size="small" @click="delet(scope.row)" v-if="gamesetfruitdeltrainrate">删除</el-button>
      </template>
...
export default {
  ...
  computed: {
    ...
    count: function () {
      return this.form4.number7big*1 + this.form4.number7small*1 + this.form4.number6big*1 + this.form4.number6small*1 + this.form4.number5big*1 + this.form4.number5small*1+ this.form4.number4big*1 + this.form4.number4small*1+ this.form4.number3big*1 + this.form4.number3small*1+ this.form4.number2big*1 + this.form4.number2small*1+ this.form4.number1big*1 + this.form4.number1small*1+ this.form4.number0big*1 + this.form4.number0small*1
    },
    count1: function () {
      let num = this.form5.number8*1 + this.form5.number7*1 + this.form5.number6*1 + this.form5.number5*1 + this.form5.number4*1 + this.form5.number3*1 + this.form5.number2*1 + this.form5.number1*1 + this.form5.number0*1
      if (this.form5.number8s == 0) {
        num = num - this.form5.number8 * 1
      }
      if (this.form5.number7s == 0) {
        num = num - this.form5.number7 * 1
      }
      if (this.form5.number6s == 0) {
        num = num - this.form5.number6 * 1
      }
      if (this.form5.number5s == 0) {
        num = num - this.form5.number5 * 1
      }
      if (this.form5.number4s == 0) {
        num = num - this.form5.number4 * 1
      }
      if (this.form5.number3s == 0) {
        num = num - this.form5.number3 * 1
      }
      if (this.form5.number2s == 0) {
        num = num - this.form5.number2 * 1
      }
      if (this.form5.number1s == 0) {
        num = num - this.form5.number1 * 1
      }
      if (this.form5.number0s == 0) {
        num = num - this.form5.number0 * 1
      }
      return num
    },
    count2: function () {
      let num = this.form6.number8*1 + this.form6.number7*1 + this.form6.number6*1 + this.form6.number5*1 + this.form6.number4*1 + this.form6.number3*1 + this.form6.number2*1+ this.form6.number1*1
      if (this.form6.number8s == 0) {
        num = num - this.form6.number8 * 1
      }
      if (this.form6.number7s == 0) {
        num = num - this.form6.number7 * 1
      }
      if (this.form6.number6s == 0) {
        num = num - this.form6.number6 * 1
      }
      if (this.form6.number5s == 0) {
        num = num - this.form6.number5 * 1
      }
      if (this.form6.number4s == 0) {
        num = num - this.form6.number4 * 1
      }
      if (this.form6.number3s == 0) {
        num = num - this.form6.number3 * 1
      }
      if (this.form6.number2s == 0) {
        num = num - this.form6.number2 * 1
      }
      if (this.form6.number1s == 0) {
        num = num - this.form6.number1 * 1
      }
      return num
    },
    count3: function () {
    ...
    sure6 () {
      ...
      if (this.count2 != 100) {
        ...
        let param = [
          ...
          {item: 1, pr: this.form6.number1 , status: this.form6.number1s },
        ]
