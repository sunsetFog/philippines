<template>
  <div class="app-container">
    ...
    <el-form :model="form2" :rules="rules2" ref="form2">
       ...
       <el-form-item label="赔率" :label-width="formLabelWidth" prop='win_rate'>
        <el-input v-model="form2.win_rate" style='width:50%'></el-input>
      </el-form-item>
  ...
  data() {
    ...
    return {
      ...
      rules2: {
        ...
        win_rate:{required: true, validator:validateMtwo, trigger: 'blur'}
      },
      name: false,
  ...
  methods: {
    ...
    edit (row) {
        ...
        request({
          ...
          this.form2.win_rate = res.data.win_rate
        }).catch(error => {
        }) 
    },
    add () {
