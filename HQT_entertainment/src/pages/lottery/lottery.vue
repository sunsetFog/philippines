                ...
                <div class="lottery_type">
                    <div class="lottery_tabs">
                        <el-tabs v-model="activeName" @tab-click="handleClick">
                            <el-tab-pane label="五星" name="/fivestars"></el-tab-pane>
                            <el-tab-pane label="四星" name="/fourstars"></el-tab-pane>
                            <el-tab-pane label="后三码" name="/afteryards"></el-tab-pane>
                            <el-tab-pane label="前三码" name="/frontyards"></el-tab-pane>
                            <el-tab-pane label="中三码" name="/middleyards"></el-tab-pane>
                            <el-tab-pane label="二码" name="/twoyards"></el-tab-pane>
                            <el-tab-pane label="定位胆" name="/location"></el-tab-pane>
                            <el-tab-pane label="不定胆" name="/nolacation"></el-tab-pane>
                            <el-tab-pane label="大小单双" name="/singledouble"></el-tab-pane>
                            <el-tab-pane label="趣味" name="/interest"></el-tab-pane>
                        </el-tabs>
                    </div>
    ...
    .add_varieties{
        .varieties_content{
            ...
            .varieties_right{
                ...
                .separation_right{
                    .mixin_div(100%,140px,none,@color_blueviolet,left);
                    line-height: normal;
                ...
                .horse_racing_right,.time_honored_right,.slect_five_right,.frequency_right{
                    .mixin_div(100%,55px,none,@color_blueviolet,left);
                    border-bottom: 1px dashed #c9c9c9;
                    padding: 0px 15px 0px 10px;
                    box-sizing: border-box;
                    ul{
        ...
        .dialog-footer{
            ...
            button:nth-of-type(1){
                .mixin_button(155px,38px,@color_indigo,@color_blueviolet);
                float: left;
                border: 1px solid @color_blueviolet;
            }
            button:nth-of-type(2){
                .mixin_button(48px,38px,none,@color_white);
                float: left;
                margin-left: 20px;
            }
        }
