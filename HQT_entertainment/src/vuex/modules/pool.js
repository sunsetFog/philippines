    ...
    state: {
		...
		pay_types: [//充值方式
			{id: 14,name: "银行卡转账",pay_code: "banktrans",pay_money: "",channel: [
				...
				{channel_id: 21,max_limit: 9000,min_limit: 0,name: "银行卡转账1",pay_code: "ALIPAY2"}
			]},
			{id: 2,name: "支付宝充值",pay_code: "alipay",pay_money: "",channel: [
				{channel_id: 20,max_limit: 10000,min_limit: 1,name: "支付宝充值1",pay_code: "ALIPAY1"},
				{channel_id: 19,max_limit: 10000,min_limit: 1,name: "支付宝充值1",pay_code: "Zhifubao"}
			]},
			{id: 1,name: "银联充值",pay_code: "online",pay_money: "",channel: [
				...
				{channel_id: 19,max_limit: 10000,min_limit: 0,name: "银联充值1",pay_code: "unionpayScan"}
			]}
		],
